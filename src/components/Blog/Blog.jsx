...
const Blog = () => {
    return (
        <div className='mb-5 p-5'>
            <h1 className='text-5xl text-center underline m-5'>Answer to the questions:</h1>
            <h1 className='text-3xl mt-3 bg-yellow-200 p-3  font-semibold'> Ques 1: When should you use context API?</h1>
            ...
            <h1 className='text-3xl mt-4  bg-yellow-100 p-3  font-semibold'> Ques 2: What is a custom hook?</h1>
            ...
            <h1 className='text-3xl mt-4  bg-yellow-200 p-3  font-semibold'> Ques 3: What is useRef?</h1>
            ...
            <h1 className='text-3xl mt-4  bg-yellow-100 p-3   font-semibold'> Ques 4:What is useMemo?</h1>
